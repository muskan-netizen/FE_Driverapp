...
const ChatMedia = ({
  ...
  const styles = styleFunc({ themeColors, isDarkMode });
  ...
  return (
    ...
    >
      <View style={{ flexDirection: isRight ? "row-reverse" : "row" }}>
        {!isRight ? (
        ...
        >
          ...
          currentMessage?.mediaType == "docs" ? (
            ...
            >
              <Image source={getImgSrc()} style={styles.docTypeImg} />

              <Text numberOfLines={1} style={styles.docTypeTxt}>
                {docName}
              </Text>
            </View>
          ...
          <Text
            style={{
              ...styles.dateTxt,
              color: isDarkMode ? "#84acaa" : colors.black,
            }}
          >
...
const styleFunc = ({ themeColors, isDarkMode }) => {
