export default {
  ...
  DIDNTRECIEVEANYCODE: "Didn't receive the code yet? ",
  ...
  SUCCESS: 'Success',
  LOADING: 'Loading',
  HOLDTOSTART: 'Tap to Start',
  HOLDTOARRIVE: 'Tap to Arrive',
  HOLDTOCOMPLETE: ' Tap to Complete',
  SIGNATURE: 'Signature',
  PHOTO: 'Photo',
  NOTES: 'Notes',
  QRCODE: 'Bar Code',
  ...
  BUY_NOW: 'Buy Now',
  MY_SUBSCRIPTION: 'My Plan',
  OTHER_SUBSCRIPTION: 'Other Plans',
  ALL_SUBSCRIPTION: 'All Plans',
  RENEW: 'Renew',
  PAY: 'Pay',
  EXPIRY: 'Expiry',
